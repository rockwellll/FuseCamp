...
class TodosControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'deleting a todo should put in trash and perform a soft deletion' do
    sign_in @user
    delete user_project_todo_list_todo_path user_id: @user, project_id: @project, todo_list_id: @todo_list, id: @todo
  ...
  test 'updating a todo will only change the todo status' do
    ...
    patch user_project_todo_list_todo_path user_id: @user, project_id: @project, todo_list_id: @todo_list, id: @todo
